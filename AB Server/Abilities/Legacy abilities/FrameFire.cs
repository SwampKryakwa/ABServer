...
namespace AB_Server.Abilities
{
    internal class FrameFireEffect
    {
        ...
        public FrameFireEffect(Bakugan user, AbilityCard target, bool isCounter, Game game, int typeID, bool IsCopy)
        {
            User = user;
            this.game = game;
            this.target = target;
    ...
    internal class FrameFire : AbilityCard
    {
