...
namespace AB_Server.Abilities
{
    internal class ScarletTwisterEffect
    {
        ...
        public ScarletTwisterEffect(Bakugan user, Bakugan target, Game game, int typeID)
        {
            User = user;
            this.game = game;
            this.target = target;
    ...
    internal class ScarletTwister : AbilityCard, IAbilityCard
    {
        ...
        {
            if (!counterNegated)
                new ScarletTwisterEffect(User, target, Game, TypeId).Activate();
