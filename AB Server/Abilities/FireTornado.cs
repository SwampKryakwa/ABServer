...
namespace AB_Server.Abilities
{
    ...
    internal class FireTornado : AbilityCard, IAbilityCard
    {
            ...
            Game.NewEvents[Owner.ID].Add(new JObject
            {
                ...
                { "Selections", new JArray {
                    new JObject {
                        ...
                        { "Ability", 1 },
                        { "SelectionBakugans", new JArray(Game.BakuganIndex.Where(x => x.InBattle && x.OnField() && x.Owner == Owner && x.Attribute == Attribute.Pyrus && !x.UsedAbilityThisTurn).Select(x =>
        ...
        {
            return Game.BakuganIndex.Any(x => x.InBattle && x.OnField() && x.Owner == Owner && x.Attribute == Attribute.Pyrus && !x.UsedAbilityThisTurn);
        }
