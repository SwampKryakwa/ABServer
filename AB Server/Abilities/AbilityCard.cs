...
namespace AB_Server.Abilities
{
    ...
    {
        // Compile-time generated registration - no runtime reflection
        public static (Func<int, Player, AbilityCard> constructor, Func<Bakugan, bool> validTarget)[] AbilityCtrs =
        [
            // Auto-generated by source generator - DO NOT EDIT MANUALLY
            // This will be replaced by the source generator at compile time
        ];
