...
namespace AB_Server.Abilities
{
    ...
    internal class RapidLight : AbilityCard, IAbilityCard
    {
        ...
        {
            return game.BakuganIndex.Any(x => game.BakuganIndex.Count(x => x.Position > 0 && x.Owner.SideID != owner.SideID) >= 2 && x.InBattle && x.Position >= 0 && x.Owner == owner && x.Attribute == Attribute.Pyrus && !x.usedAbilityThisTurn);
        }
