...
namespace AB_Server.Abilities
{
    ...
    internal class Marionette : AbilityCard
    {
        ...
        public void Setup2()
        {
            ...
            Game.NewEvents[Owner.Id].Add(EventBuilder.SelectionBundler(
                EventBuilder.FieldBakuganSelection("INFO_ABILITYTARGET", TypeId, (int)Kind, Game.BakuganIndex.Where(x => x.OnField() && x.Owner.SideID != Owner.SideID && x.Position != User.Position))
            ));
